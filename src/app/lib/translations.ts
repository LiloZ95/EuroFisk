...
export const T = {
  sv: {
    ...
    contactSub: "Boka ett bord eller kontakta oss för frågor. Vi tar emot bokningar för sällskap upp till 20 personer.",
    contactInfo: [
  ...
  en: {
    ...
    contactSub: "Book a table or contact us with any questions. We accept bookings for groups up to 20 people.",
    contactInfo: [
